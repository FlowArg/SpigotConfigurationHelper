...
public abstract class SpigotConfigurationEntry<T>
{
    ...
    /**
     * Construct a new {@link SpigotConfigurationEntry}.
     * @param path          path in the {@link FileConfiguration} of the key.
     * @param configuration given configuration. Nothing else to add.
     */
    public SpigotConfigurationEntry(String path, FileConfiguration configuration)
    {
        this.path = path;
    ...
    /**
     * Set the given value in the {@link SpigotConfigurationEntry#path}
     *
